namespace Lorenzo_InterTransit_MVC.Migrations
{
    ...
    public partial class lolow1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        BKG_NUM = c.String(nullable: false, maxLength: 40, unicode: false),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.CTN_REF)
                .ForeignKey("dbo.TypeTC", t => t.TYTC_ID)
                .ForeignKey("dbo.Booking", t => t.BKG_NUM)
                .Index(t => t.TYTC_ID)
                .Index(t => t.BKG_NUM);
